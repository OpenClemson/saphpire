<?php
     ...
     * @version    0.1.0
     */
    class cValidateString extends cValidateBase
    {
        /**
         ...
         */
        public function ValidateAlnum( $sValue, $bStrict = false, $sErrorMessage = null )
        {
            try
            {
                ...
                elseif( !$bStrict && preg_match( "/^([a-z0-9\x20])+$/i", $sValue ) )
                {
                    $vReturn = true;
                }
