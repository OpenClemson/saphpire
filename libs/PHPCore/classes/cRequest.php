<?php
    ...
    require_once( sCORE_INC_PATH . '/classes/cRequestAbs.php' );
    ...
    class cRequest
    {
        ...
        /**
         * getter for $sHttpStatusCode.
         *
         * @throws  Exception rethrows anything it catches.
         *
         * @return  string  $this->oRequestObj->sHttpStatusCode
         */
        public function GetStatus()
        {
            try
            {
                return $this->oRequestObj->sHttpStatusCode;
            }
            catch( Exception $oException )
            {
                throw cAnomaly::BubbleException( $oException );
